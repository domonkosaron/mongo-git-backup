...
async function pureExport({
    ...
    console.log(dir);
    console.log(chalk.yellow([host, port, db]));
    ...
    for (const collection of collectionNames) {
        ...
        console.log(await run(`mongoexport --forceTableScan --host ${host} --port ${port} --db ${db} --collection ${collection} --out ${tmpDir}/${collection}.json`));
    }
